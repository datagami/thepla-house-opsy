...
const activityTypeLabels: Record<ActivityType, string> = {
  ...
  REFERRAL_BONUS_PROCESSED: "Referral Bonus Processed",
  REFERRAL_ARCHIVED: "Referral Archived",
  ENET_FILE_DOWNLOADED: "ENET File Downloaded",
  ...
  PUNCH_IN: "Kiosk Punch In",
  PUNCH_OUT: "Kiosk Punch Out",
  PUNCH_BLOCKED_WRONG_OUTLET: "Kiosk Punch Blocked (Wrong Outlet)",
  GROOMING_CHECK_FAILED: "Grooming Check Failed",
  FINGERPRINT_ENROLLED: "Fingerprint Enrolled",
  KIOSK_DEVICE_CREATED: "Kiosk Device Provisioned",
  OTHER: "Other",
};
...
const activityTypeColors: Record<string, string> = {
  ...
  ATTENDANCE_DELETED: "bg-red-100 text-red-800",
  ...
  SALARY_DELETED: "bg-red-100 text-red-800",
  REFERRAL_BONUS_PROCESSED: "bg-purple-100 text-purple-800",
  REFERRAL_ARCHIVED: "bg-orange-100 text-orange-800",
  ENET_FILE_DOWNLOADED: "bg-blue-100 text-blue-800",
  ADVANCE_PAYMENT_APPROVED: "bg-green-100 text-green-800",
  ADVANCE_PAYMENT_REJECTED: "bg-red-100 text-red-800",
  SALARY_APPRAISAL: "bg-emerald-100 text-emerald-800",
  DAILY_ATTENDANCE_REPORT: "bg-teal-100 text-teal-800",
};
